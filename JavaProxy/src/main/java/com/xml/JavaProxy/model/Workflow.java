...
@XmlRootElement(name = "workflow", namespace = "http://ftn.uns.ac.rs/xml2019/workflow")
public class Workflow {

    @XmlElement(namespace = "http://ftn.uns.ac.rs/xml2019/workflow", required = true)
    protected String publicationId;
    @XmlElement(namespace = "http://ftn.uns.ac.rs/xml2019/workflow", required = true)
    protected Workflow.Reviewers reviewers;
    @XmlElement(namespace = "http://ftn.uns.ac.rs/xml2019/workflow", required = true)
     ...
     * @return
     *     possible object is
     *     {@link Workflow.Reviewers }
     *     
     */
    public Workflow.Reviewers getReviewers() {
        return reviewers;
    }
     ...
     *     
     */
    public void setReviewers(Workflow.Reviewers value) {
